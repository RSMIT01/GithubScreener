...
export async function summarizeCode(doc: Document) {
  ...
  try {
    ...
    const response = await model.generateContent([
      ...
      `You are onboarding a junior software engineer and explaining to them purpose of the ${doc.metadata.source} file
      Here is code from the ${doc.metadata.source} file:
      ---
    ${code}
    --- 
